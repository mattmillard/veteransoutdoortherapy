...
export const fieldStories: FieldStory[] = [
	{
		...
		body: [
			"Female Veterans traveled from Alabama, Wisconsin, South Dakota, and Missouri for the first annual Coulter Lake Guest Ranch Horseback Riding Adventure in July 2026.",
			"The multi-day gathering centered on horseback riding, shared meals, open country, and time with other Veterans. Coulter Lake Guest Ranch & Outfitters hosted the experience as a mission partner.",
			"Experiences like this are designed to remove common cost barriers for selected participants while creating room for camaraderie and connection outdoors.",
		],
